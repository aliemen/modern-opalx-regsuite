    ...
    <div className="flex items-center justify-between mt-4 text-xs text-muted">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          disabled={!hasPrev}
          className="flex items-center gap-0.5 px-2 py-1 border border-border rounded-md hover:text-fg hover:border-accent/30 transition-colors disabled:opacity-40 disabled:pointer-events-none"
        >
          <ChevronLeft size={13} />
          Prev
        </button>
